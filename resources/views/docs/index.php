    ...
    <div class="docs-container">
        ...
        <div class="docs-tab-panel active" id="docs-panel">
            ...
            <?= renderSection('cube-outline', 'Core Architecture', [
                ...
                renderCard('/docs/validation-system', 'check-decagram', 'Validation System', '66+ validation rules, custom rules.', 'essential'),
                renderCard('/docs/error-reporter', 'alert-circle-outline', 'Error Reporter', 'Floating error display with responsive mobile modal, 6 positions, and click-to-focus.', ['new', 'ui', 'validation']),
        ...
        <div class="docs-tab-panel" id="dev-panel">
            ...
            <?= renderSection('application-cog', 'Controllers & Views', [
                ...
                renderCard('/docs/dev-error-reporter', 'alert-circle-outline', 'Error Reporter Guide', 'Complete API reference, events, customization, and advanced patterns.', ['new', 'guide', 'api']),
